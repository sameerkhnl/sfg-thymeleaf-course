...
import guru.springframework.domains.Author;
import guru.springframework.domains.Product;
import guru.springframework.domains.ProductCategory;
...
public class ProductServiceImpl implements ProductService {
    ...
    public void loadProducts() {
        ...
        springIntro.setCourseDescription("Why would you want to learn about the Spring Framework? Simple, Spring is " +
                "the most widely used framework in the enterprise today. Major companies all over the world are " +
                "hiring programmers who know the Spring Framework.\n" +
                "\n" +
                "My Introduction Spring Framework Tutorial is designed to give you an introduction to the Spring " +
                "Framework. This course is written for beginners. Ideally before taking the course, you should " +
                "already have a foundation with the Java programming language. You don't need to be an expert in " +
                "Java, but you should the basics of Object Oriented Programming with Java.\n" +
                "\n" +
                "You will learn what Dependency Injection is, and how Spring uses Inversion of Control to leverage " +
                "Dependency Injection. Next in my course, I will walk you step by step through building your very " +
                "first Spring Framework application. I'll show you hot to use the Spring Initializer and Spring Boot " +
                "to jumpstart your Spring Framework project. Ideally, you can follow along and create your own Spring" +
                " project. I know it can be frustrating to follow along in a course and run into errors. So don't " +
        ...
        springCoreUltimate.setCourseDescription("Why would you want to learn about the Spring Framework? Simple, " +
                "Spring is the most widely used framework in the enterprise today. Major companies all over the world" +
                " are hiring programmers who know the Spring Framework.\n" +
                "\n" +
                "My Introduction Spring Framework Tutorial is designed to give you an introduction to the Spring " +
                "Framework. This course is written for beginners. Ideally before taking the course, you should " +
                "already have a foundation with the Java programming language. You don't need to be an expert in " +
        ...
        thymeleaf.setCourseDescription("Why would you want to learn about the Spring Framework? Simple, Spring is the" +
                " most widely used framework in the enterprise today. Major companies all over the world are hiring " +
                "programmers who know the Spring Framework.\n" +
                "\n" +
                "My Introduction Spring Framework Tutorial is designed to give you an introduction to the Spring " +
                "Framework. This course is written for beginners. Ideally before taking the course, you should " +
                "already have a foundation with the Java programming language. You don't need to be an expert in " +
        ...
        springCore.setCourseDescription("Why would you want to learn about the Spring Framework? Simple, Spring is " +
                "the most widely used framework in the enterprise today. Major companies all over the world are " +
                "hiring programmers who know the Spring Framework.\n" +
                "\n" +
                "My Introduction Spring Framework Tutorial is designed to give you an introduction to the Spring " +
        ...
        springCoreAdv.setCourseDescription("Why would you want to learn about the Spring Framework? Simple, Spring is" +
                " the most widely used framework in the enterprise today. Major companies all over the world are " +
                "hiring programmers who know the Spring Framework.\n" +
                "\n" +
                "My Introduction Spring Framework Tutorial is designed to give you an introduction to the Spring " +
        ...
        springCoreDevOps.setCourseDescription("Why would you want to learn about the Spring Framework? Simple, Spring" +
                " is the most widely used framework in the enterprise today. Major companies all over the world are " +
                "hiring programmers who know the Spring Framework.\n" +
                "\n" +
                "My Introduction Spring Framework Tutorial is designed to give you an introduction to the Spring " +
                "Framework. This course is written for beginners. Ideally before taking the course, you should " +
